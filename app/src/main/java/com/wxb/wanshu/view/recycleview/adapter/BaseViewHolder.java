...
//        Glide.with(mContext).load(imgUrl).apply(placeholder).into(view);
    ...
    public BaseViewHolder setCircleImageUrl(int viewId, String imgUrl, int placeHolderRes) {
        ImageView view = getView(viewId);
//        RequestOptions placeholder = new RequestOptions().placeholder(placeHolderRes).transform(new CircleCrop());
//        Glide.with(mContext).load(imgUrl).apply(placeholder).into(view);
        ImageUtils.displayCircleImage(mContext, view, imgUrl);
        return this;
    }

    public BaseViewHolder setRoundImageUrl(int viewId, String imgUrl, int radius, int placeHolderRes) {
        ImageView view = getView(viewId);
