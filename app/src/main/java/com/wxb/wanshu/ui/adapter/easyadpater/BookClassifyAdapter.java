...
public class BookClassifyAdapter extends EasyRVAdapter<NovelCategory.DataBean> {
    private OnRvItemClickListener itemClickListener;

    public BookClassifyAdapter(Context context, List<NovelCategory.DataBean> list, OnRvItemClickListener itemClickListener) {
