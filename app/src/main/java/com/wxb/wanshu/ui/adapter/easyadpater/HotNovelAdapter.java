...
public class HotNovelAdapter extends EasyRVAdapter<HotNovelList.DataBean> {
    private OnRvItemClickListener itemClickListener;

    public HotNovelAdapter(Context context, List<HotNovelList.DataBean> list, OnRvItemClickListener listener) {
    ...
    @Override
    protected void onBindData(EasyRVHolder viewHolder, int position, HotNovelList.DataBean item) {
        viewHolder.setText(R.id.article_title, item.getName()).setText(R.id.tv_sort, "" + (position + 1));
